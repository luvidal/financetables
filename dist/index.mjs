...
var SummaryTable = ({ columnHeaders, rows, extraColumn, renderLabelSuffix, columnWidth = "w-[120px]" }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsx("table", { className: "w-full text-sm border-collapse", children: /* @__PURE__ */ jsx("tbody", { children: rows.map((row, idx) => {
    if (row.type === "subheader") {
      return /* @__PURE__ */ jsxs("tr", { className: "border-b-2 border-gray-300", children: [
        /* @__PURE__ */ jsx("td", { className: "py-2 px-3 text-xs font-bold text-gray-800 uppercase tracking-wider", children: row.label }),
        extraColumn && /* @__PURE__ */ jsx("td", { className: `py-2 px-3 text-right text-xs font-bold text-gray-600 ${extraW}`, children: extraColumn.header }),
        columnHeaders.map((col, i) => /* @__PURE__ */ jsx("td", { className: `py-2 px-3 text-right text-xs font-bold text-gray-600 ${columnWidth}`, children: col }, i))
      ] }, idx);
    }
    ...
    return /* @__PURE__ */ jsxs(
      "tr",
      {
        ...
        children: [
          ...
          extraColumn && /* @__PURE__ */ jsx("td", { className: `py-1.5 px-1 ${extraW}`, children: extraColumn.render(row, idx) }),
          row.values.map((v, i) => {
