...
var SummaryTable = ({ columnHeaders, rows, extraColumn, renderLabelSuffix, columnWidth = "w-[120px]" }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsx("table", { className: `${T.table} text-sm border-collapse`, children: /* @__PURE__ */ jsx("tbody", { children: rows.map((row, idx) => {
    if (row.type === "subheader") {
      return /* @__PURE__ */ jsxs("tr", { className: T.sumSubheaderRow, children: [
        /* @__PURE__ */ jsx("td", { className: T.sumSubheaderLabel, children: row.label }),
        extraColumn && /* @__PURE__ */ jsx("td", { className: `${T.sumSubheaderCol} ${extraW}`, children: extraColumn.header }),
        columnHeaders.map((col, i) => /* @__PURE__ */ jsx("td", { className: `${T.sumSubheaderCol} ${columnWidth}`, children: col }, i))
      ] }, idx);
    }
    const s = ROW_STYLES[row.type] ?? ROW_STYLES.data;
    const fmt = row.format ?? "currency";
    return /* @__PURE__ */ jsxs("tr", { className: s.row, children: [
      /* @__PURE__ */ jsxs("td", { className: s.label, children: [
        row.label,
