...
var DeudasTable = ({
  ...
  const visibleRowIds = React4.useMemo(() => activeRows.map((e) => e.id), [activeRows]);
      ...
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("td", { className: `px-2 py-2.5 text-gray-700 ${T.cellLabel}`, style: { width: "180px" }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntime.jsx(deletebutton_default, { onClick: () => requestDelete(entry.id), isVisible: isHovered, size: "default", title: "Eliminar fila" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntime.jsx(viewsourcebutton_default, { sourceFileId: entry.sourceFileId, onViewSource, isVisible: isHovered, size: "default" })
          ] }) }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      tableshell_default,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(recyclebin_default2, { deletedRows, getLabel: (r) => r.entidad, onRestore: restoreRow })
        ]
      }
    ),
...
var DeudasConsumoTable = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-x-auto", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsxs("tr", { className: `${headerBg} border-t border-rose-200 ${headerText}`, children: [
              ...
              "tr",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs("td", { className: "relative", style: { width: "110px" }, children: [
                    ...
                    isHovered && row.cuota_estimated && row.saldo_deuda_pesos != null && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "absolute right-0 top-1/2 -translate-y-1/2 translate-x-[2px] group/info", children: [
